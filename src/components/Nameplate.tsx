...
export default function Nameplate() {
  ...
  return (
    <header ref={containerRef} className="editorial-section relative overflow-hidden">
      {/* Warm background image */}
      {personalInfo.images?.hero && (
        <div className="absolute inset-0 z-0" aria-hidden="true">
          <Image
            src={personalInfo.images.hero}
            alt=""
            fill
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-paper/80 to-paper" />
        </div>
      )}

      <div className="relative z-10 flex flex-col md:flex-row md:items-start md:justify-between max-w-5xl">
        <div className="max-w-4xl">
          ...
          <p className="nameplate-role mono-text text-pink mb-2">
            {personalInfo.title}
          </p>

          <p className="nameplate-tagline body-text text-sm text-charcoal italic mb-8">
            {personalInfo.tagline}
          </p>

          <p className="nameplate-desc body-text-large max-w-prose">
