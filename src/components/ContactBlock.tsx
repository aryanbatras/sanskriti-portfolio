...
export default function ContactBlock() {
  ...
  return (
    <section id="contact" ref={containerRef} className="editorial-section bg-abstract-light">
        ...
        <div className="space-y-8">
          <div className="contact-reveal">
            <p className="body-text text-lg">
              <a href={`mailto:${personalInfo.email}`} className="text-link">{personalInfo.email}</a>
            </p>
